...
function buildPayPage(d) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8">'
    ...
    + '<p class="fine">By paying, you confirm this is your complete order. Items not listed will not be included. You will receive a photo of the stocked home before check-in. See our <a href="/terms">Terms</a> and <a href="/privacy">Privacy Policy</a>.</p>'
    + '</div></body></html>';
}
